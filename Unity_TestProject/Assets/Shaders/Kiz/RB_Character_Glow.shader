...
Shader "Rocket Boy/Character/Probe Lighting (Colored Glow)"
{
	Properties
	{
		...
		_GlowColor("Glow Color (A = Intensity)", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 _Tint, _VertTint, _GlowColor;
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				// diffuse shading
				fixed4 c = main;
				c.xyz = main * lerp(fixed3(1,1,1), i.diffuse, 1 - spec.aaa);
