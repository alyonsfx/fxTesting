// Uses a Particle System's custom vertex stream to translate verts
// Moves particles based on a target transform's position
// Particle System requires ParticleMagnet.cs

Shader "Custom/Particles/Custom Data/Additive (Magnet)"
{
    Properties
    {
