Shader "Sprites/Custom/3 Color Gradient"
{
    Properties
    {
        ...
        _ColorMid ("Middle", Color) = (1, 1, 1, 1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(v2f i): SV_Target
            {
                ...
                float4 c = _ColorBot + (_ColorMid - _ColorBot) * (min(temp, _Middle) / _Middle) + (_ColorTop - _ColorMid) * (max(temp - _Middle, 0) / (1 - _Middle)) * i.color;
                return c * i.color.a;
            }
