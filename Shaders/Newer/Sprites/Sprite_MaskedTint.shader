// Applies the Vertex color as a tint, masked to the Texture's Alpha
Shader "Custom/Sprites/Masked Tint"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				half4 col = SampleSpriteTexture(IN.texcoord);
				col.rgb = lerp(col.rgb, col.rgb * IN.color.rgb, col.a);
				col.a = IN.color.a;
				col.rgb *= col.a;
				return col;
			}
